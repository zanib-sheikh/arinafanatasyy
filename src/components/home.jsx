...
<div className="absolute animate-pulse w-full h-full z-1 shadow-lg border-collapse clip-parallelogram-mirror"></div>
...
<div id="feature" className="flex my-2 lg:mt-2 sm:mt-0 items-center w-full">
  <div className="relative w-full px-6 my-2 lg:mt-2 sm:mt-0 lg:mb-10 mb-12 lg:px-11">
    ...
    <div className="relative flex flex-col lg:flex-row mt-2 items-center w-full z-10">
     ...
     {/* Left: Images */}
<div className={`relative flex-1 flex items-center justify-center pr-0 pl-11 lg:pl-0 lg:pr-24 lg:justify-center lg:items-center lg:left-2 mt-8 ${i18n.language === "ar" ? "lg:pr-32 lg:pl-0" : ""}`}>
  
  {/* First Image */}
  <img
    src={phone}
    alt={i18n.language === "ar" ? "ميزة الهاتف" : "Phone Feature"}
    className={`w-64 lg:w-84 h-auto object-contain relative z-10 transform translate-x-0 ${i18n.language === "ar" ? "lg:translate-x-[52px]" : "lg:translate-x-[-52px]"}`}
  />
  ...
  <img
    ...
    className={`w-6/7 lg:w-3/4 h-auto object-contain absolute z-20 transform translate-x-[40px] ${i18n.language === "ar" ? "lg:translate-x-[-20px]" : "lg:translate-x-[20px]"}`}
  />
</div>
